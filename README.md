...
<img width="300" height="235" alt="image" src="https://github.com/user-attachments/assets/ee17f949-896a-4d2c-95be-65bffd9912e5" />
...
- Object Type : Each object has a type attached to it, for example, nbr 50 is the number 50, txt 50 is the text "50" and so
    ...
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/5a3f8bd8-ba53-4a81-8677-0236653652e3" />
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/f320a4c8-cb3a-4a15-b8dd-5bdb53cd3d84" />
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/0c9c09fe-5c4a-400c-b3e4-f9864b571d9f" />
...
- For Loop : Do something x number of times.
     "for i 10" runs the following lines 10 times, each time the variable "i" increases by 1. You can also do "for i 5,10" which starts at 5 and goes to 10 (not included).
     Or you could do "for i 3,7,2" which goes from 3 to 7 but adds +2 each time instead of 1.
  
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/01869922-f7a5-4ccd-925b-897d9765da58" />
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/9f566b97-380b-4bf5-9d9f-e2b40332ecd7" />
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/1a98e7a5-d0ce-4a19-9cd3-90d2aa856b18" />
...
- While Loop : Repeat something until a condition is met (!MIGHT CRASH IF CONDITION CAN NEVER BE FULLFILLED). 
    ...
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/228bf7d0-dad2-48a5-a71b-940ea5310eb5" />
...
- Functions : When called, execute a small piece of code, you first have to tell the function what code to execute, then you can run it a lot of times without rewriting it.
    ...
    <img width="400" height="275" alt="image" src="https://github.com/user-attachments/assets/9593c7ef-0a11-4c8a-a055-d8fe6ed8cd49" />
